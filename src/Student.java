...
public class Student {
    ...
    public int getMax() {
        ...
        try {
           ...
           Logger.getLogger(Student.class.getName()).log(Level.SEVERE, "Error getting max ID", ex);
        }
        return id +1;
    }
    ...
    public void delete(int id) {
        int yesOrNo = JOptionPane.showConfirmDialog(null, "Course and Scores will also be deleted", "Student Deleted", JOptionPane.OK_CANCEL_OPTION, 0);
